...
import NextModal1Steps from "@/components/NextModal1/NextModal1Steps.vue";
import NextModal2Steps from "@/components/NextModal2/NextModal2Steps.vue";
import TestModalSteps from "@/components/TestModal/TestModalSteps.vue";
...
export default defineComponent({
    ...
    components: { TestModalSteps, NextModal1Steps, NextModal2Steps, Card },
});
</script>
...
<template>
    <div class="container">
        ...
        <test-modal-steps :show="showTest1" @close="showTest1 = false" />
        <next-modal-1-steps :show="showTest2" @close="showTest2 = false" />
        <next-modal-2-steps :show="showNext" @close="showNext = false" />
    </div>
</template>
